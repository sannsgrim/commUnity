...
import UserGuestLayout from "@/Layouts/UserGuestLayout.vue";
...
<template>
    <Head title="Welcome"/>
    <UserGuestLayout :canLogin="canLogin" :canRegister="canRegister">
                ...
                <div
                    ...
                    <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
                        ...
                        <p class="pr-5 mb-5 text-base text-gray-700 md:text-lg">
                            Chime connects people through posts and meaningful interactions, making sharing and
                            discovering effortless.
                        </p>
